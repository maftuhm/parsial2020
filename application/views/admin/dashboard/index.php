            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <div class="alert alert-warning alert-dismissible">
                        ...
                        <h4><i class="icon fa fa-warning"></i> Mohon perhatiannya!</h4>
                        Website ini masih dalam pengembangan. Jadi masih <strong>belum</strong> bekerja secara maksimal. Harap bersabar yaa :) 
                    </div>
                    <div class="row">
