														...
														<table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
															<tr style="border-collapse:collapse;">
																<td align="center" style="padding:0;margin:0;padding-top:20px;padding-left:40px;padding-right:40px;">
																	<h1 style="margin:0;line-height:36px;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;font-size:26px;font-style:normal;font-weight:normal;color:#333333;"><?php echo $title; ?></h1>
																</td>
															</tr>
															<tr style="border-collapse:collapse;">
														...
														<table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
															...
															<tr style="border-collapse:collapse;">
																<td align="center" style="padding:10px;margin:0;">
																	...
																	<a href="#" style="display: none;"><?php echo rand(); ?></a>
																</td>
															</tr>
														</table>
													</td>
