...
?>
			...
			<div class="form-container">
				...
				<form action="<?php echo current_url();?>" method="post" autocomplete="on" id="form1">
					...
					<div class="form-grup">
						<hr>
						<input type="checkbox" name="syarat_ketentuan" required />Saya sudah membaca dan menyetujui <a href="http://himatika.fst.uinjkt.ac.id/parsial2020/mcc/sk/" target="_blank">Syarat dan Ketentuan</a> 
					</div>
