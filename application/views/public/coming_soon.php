...
<head>
	<!---
	Welcome to our free coming soon page template by http://comingsoonpage.com Get your free download at //www.seedprod.com/free-coming-soon-page/
	...
	8. Set your MailChimp email post URL on line 300 See video: //youtu.be/YUdP1qfMot8
	...
	<link rel="shortcut icon" href="//static.comingsoonpage.com/cspio-assets/1.0.0/favicon.ico">
	...
	<link rel="stylesheet" href="//static.comingsoonpage.com/cspio-assets/1.0.0/style.css">

	<!-- Google Fonts -->
	<link class="gf-headline" href='//fonts.googleapis.com/css?family=Pacifico:400&subset=' rel='stylesheet' type='text/css'>
	...
	html{
		height:100%;
		background-image: url("<?php echo base_url($templates_dir . '/coming_soon/bg.jpg'); ?>"); no-repeat center bottom fixed;
	...
	<div id="cspio-page">
		<div id="cspio-content">
			...
			<div id="cspio-socialprofiles">
				<a href="//facebook.com/parsial.himatika.3" target="_blank"><i class="fa fa-facebook-official fa-2x"></i></a>
				<a href="//instagram.com/parsialhimatika.uinjkt" target="_blank"><i class="fa fa-instagram fa-2x"></i></a>			
				<a href="mailto:parsialhimatika.uinjkt@gmail.com" target="_blank"><i class="fa fa-envelope fa-2x"></i></a>
			</div>
